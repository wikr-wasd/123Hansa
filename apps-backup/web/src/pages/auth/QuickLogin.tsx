...
const QuickLogin: React.FC = () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        if (data.data.user.role === 'admin') {
          ...
          navigate('/'); // Redirect regular users to homepage for now
        }
      } else {
  ...
  return (
    <>
      <Helmet>
        <title>Inloggning - 123hansa.se</title>
      </Helmet>
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-3xl font-bold text-gray-900">
              Logga in på 123hansa.se
            </h2>
            <p className="mt-2 text-sm text-gray-600">
              Välj ett testkonto eller ange dina egna uppgifter
            </p>
          </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
              <div className="flex">
                ...
                <div className="text-sm text-yellow-800">
                  <p className="font-medium">Demo-miljö</p>
                  <p>Detta är en testmiljö. Använd testkontona ovan för att prova systemet.</p>
                </div>
              </div>
            </div>
