...
/** Branscher med egna multiplar. `other` används när branschen är okänd. */
export type ValuationIndustry =
  | 'software'
  | 'ecommerce'
  | 'consulting'
  | 'manufacturing'
...
export const INDUSTRY_MULTIPLES: Readonly<Record<ValuationIndustry, IndustryMultiples>> = {
