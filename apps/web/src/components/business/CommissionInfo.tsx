...
import { Calculator, Handshake, Shield, CheckCircle } from 'lucide-react';
      ...
      <div className="space-y-4">
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
          <div className="flex items-center mb-3">
            ...
            <h4 className="font-semibold text-purple-900">Säkra Avtal med Handshake</h4>
          </div>
          <p className="text-sm text-purple-800 mb-3">
            Alla avtal hanteras via vår partner-app <strong>Handshake</strong> för maximal säkerhet och transparens.
          </p>
